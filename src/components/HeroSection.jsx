...
return (
<section 
className="relative min-h-screen w-full flex flex-col items-center justify-start overflow-hidden pt-4 md:pt-16 pb-4 md:pb-16 px-4"
>
{/* Premium tagline */}
<div
ref={taglineRef}
className="relative z-10 mb-2 md:mb-12"
style={{
